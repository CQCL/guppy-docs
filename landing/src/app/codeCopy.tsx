...
export const CodeCopy = (props: {textToCopy: string, className?: string}) => {
    ...
    return <div className="bg-tealCustom text-gray-100 w-full flex  items-center justify-center self-start whitespace-nowrap rounded-lg bg-gradient-to-r from-zinc-600 to-slate-600  py-3 pl-4 text-center text-4xl font-semibold  dark:from-zinc-600 dark:to-slate-600">
